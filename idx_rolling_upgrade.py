...
if __name__ == '__main__':
    ...
    example_text = '''example:
     ...
     python idx_rolling_upgrade.py -u https://example.com:8089 -d /opt/splunk -r /tmp/splunk-7.1.1-8f0ead9ec3db-linux-2.6-x86_64.rpm --auth admin:changed -t indexerip
    '''
    ...
    parser.add_argument('-t', '--target', required=True, action="store", type=str, help="Specify target indexer ip")
    ...
    initUri = argList.uri_of_peernode + DECOMISSION_REST
   ...
   # Need to add decommision stataus and waiting offline timeout 
    ...
    finalizeUri = argList.uri_of_peernode + UPGRADE_FINALIZE_REST
